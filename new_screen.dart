...
void handleWeb(String screenName, bool shouldIncludeScreenParams) async {
  final className = getClassName(screenName);
  final screenClass = className + 'Screen';
  final cubitClass = className + 'Cubit';
  final stateClass = className + 'State';
  ...
  final path = '$pathToWebPages/$screenName/view';
  Directory(path).create(recursive: true);
  final screen =
      await File('$path/${screenName}_screen.dart').create(recursive: true);
...
import 'package:bill_share/di/dependency_injection.dart';
import 'package:bill_share/common/base_screen.dart';
import 'package:bill_share/web/pages/$screenName/view/${screenName}_cubit.dart';
import 'package:bill_share/web/pages/$screenName/view/${screenName}_state.dart';
import 'package:bill_share/web/pages/$screenName/view/${screenName}_screen_params.dart';
import 'package:bill_share/services/navigation/api/navigation_provider.dart';
import 'package:flutter/material.dart';
...
''');
  ...
  if (shouldIncludeScreenParams) {
    final params = await File('$path/${screenName}_screen_params.dart')
        .create(recursive: true);
    params.writeAsString('''
import 'package:bill_share/web/pages/$screenName/view/${screenName}_screen.dart';
import 'package:bill_share/services/navigation/api/screen_parameters.dart';
