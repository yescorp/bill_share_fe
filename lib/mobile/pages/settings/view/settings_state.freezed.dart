...
abstract class $SettingsStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({UserInfo? info, int monthlyLimit});
}
...
class _$_SettingsState implements _SettingsState {
  _$_SettingsState({this.info, this.monthlyLimit = 0});
  ...
  @override
  String toString() {
    return 'SettingsState(info: $info, monthlyLimit: $monthlyLimit)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, info, monthlyLimit);
...
abstract class _SettingsState implements SettingsState {
  factory _SettingsState({final UserInfo? info, final int monthlyLimit}) =
      _$_SettingsState;
