...
class _$_FriendsListState implements _FriendsListState {
  ...
  @override
  String toString() {
    return 'FriendsListState(friends: $friends, friendshipRequests: $friendshipRequests, groups: $groups, isSearch: $isSearch, update: $update)';
  }
...
abstract class _FriendsListState implements FriendsListState {
  factory _FriendsListState(
      ...
      final bool isSearch,
      final bool update}) = _$_FriendsListState;
