...
abstract class $HomeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Widget> screens, int selectedScreen});
}
...
class _$_HomeState implements _HomeState {
  _$_HomeState({final List<Widget> screens = const [], this.selectedScreen = 0})
      : _screens = screens;
  ...
  @override
  String toString() {
    return 'HomeState(screens: $screens, selectedScreen: $selectedScreen)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_screens), selectedScreen);
...
abstract class _HomeState implements HomeState {
  factory _HomeState({final List<Widget> screens, final int selectedScreen}) =
      _$_HomeState;
